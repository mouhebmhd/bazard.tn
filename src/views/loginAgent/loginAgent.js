...
function Login()
{
  ...
  <div className=" container-fluid">
    <div className="row loginDivContainer">
      ...
      <div className="avatarContainer"></div>
              ...
              <form className="pt-3 bg-white" id="loginForm"  name="loginForm" >
                ...
                <div className="mb-2 mt-3 text-center">
                   <NavLink to='/agent/register'> <button tabIndex="4" href="" className="btn createAccount" ><i className="bi  bi-person-plus-fill"> </i>Créer un compte </button></NavLink>
                </div>
