...
function Register() {
  ...
  function loginFunction() {
    axios.post('http://localhost:3030/agent/addNewAgent/',{customerName, customerEmail, customerPhoto, customerPhoneNumber, customerAddressRegion, customerAddressCity, customerAddressPostalCode, customerPassword} )
      .then(response => {
